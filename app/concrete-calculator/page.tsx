...
export const metadata: Metadata = {
  title: "Concrete Calculator — Cubic Yards, Bags & Cost",
  description:
    "Calculate how much concrete you need for any slab, footing, or wall. Get cubic yards, 60-lb and 80-lb bag counts, and ready-mix cost instantly.",
...
export default function ConcretePage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Concrete Calculator</h1>
