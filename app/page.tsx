...
const calculators = [
  {
    ...
    desc: "Calculate lumber volume in board feet by thickness, width, and length.",
    icon: "🪵",
    kw: "22,200 searches/mo",
  },
  {
    slug: "stud-calculator",
    name: "Stud / Framing Calculator",
    desc: "Find how many wall studs you need for any wall length and stud spacing.",
    icon: "🏗️",
    kw: "3,600 searches/mo",
  },
  {
    slug: "roof-pitch-calculator",
    name: "Roof Pitch Calculator",
    desc: "Convert roof pitch to angle, calculate rise and run for any roof slope.",
    icon: "🏠",
    kw: "14,800 searches/mo",
  },
  {
    slug: "rebar-calculator",
    name: "Rebar Calculator",
    desc: "Calculate rebar quantity, spacing, and total weight for slabs and footings.",
    icon: "⚙️",
    kw: "4,400 searches/mo",
  },
  {
    slug: "brick-calculator",
    name: "Brick Calculator",
    desc: "Estimate bricks and mortar needed for walls, patios, and walkways.",
    icon: "🧱",
    kw: "4,400 searches/mo",
  },
  {
    ...
    desc: "Calculate flooring materials for any room with waste factor included.",
    icon: "📐",
    kw: "3,600 searches/mo",
  },
  {
    ...
    desc: "Calculate how many bags or tons of sand you need by area and depth.",
    icon: "🏖️",
    kw: "6,600 searches/mo",
  },
  {
    slug: "asphalt-calculator",
    name: "Asphalt Calculator",
    desc: "Estimate asphalt tonnage for driveways, parking lots, and roads.",
    icon: "🛣️",
    kw: "22,200 searches/mo",
  },
];
